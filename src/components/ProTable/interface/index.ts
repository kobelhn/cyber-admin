...
export interface EnumProps {
  ...
  tagType?: "primary" | "success" | "info" | "warning" | "danger"; // 当 tag 为 true 时，此选择会指定 tag 显示类型
...
export interface ColumnProps<T = any>
  ...
  dateFormate?: boolean | "YYYY-MM-DD HH:mm:ss" | "YYYY-MM-DD HH:mm" | "YYYY-MM-DD" | "HH:mm:ss" | "HH:mm" | "mm:ss";
}
