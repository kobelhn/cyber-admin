    ...
    <div class="table-header">
      ...
      <div v-if="toolButton" class="header-button-ri">
        <slot name="toolButton">
          <el-tooltip v-if="showToolButton('refresh')" content="刷新表格" placement="top">
            <el-button :icon="Refresh" circle @click="getTableList" />
          </el-tooltip>
          <el-tooltip v-if="showToolButton('setting') && columns.length" content="表格列设置" placement="top">
            <el-button :icon="Operation" circle @click="openColSetting" />
          </el-tooltip>
          <el-tooltip v-if="showToolButton('search') && searchColumns?.length" content="展开/隐藏搜索栏" placement="top">
